...
namespace AnimalModel
{
    ...
    public class Panda : IAnimalModel
    {
        ...
        /// </summary>
          ...
          private string _imageName = "Panda"; // This is used to store the type/name of an animal.
        ...
        /// <returns>It returns the calculator associated with the animal.</returns>
          ...
          {
              //This combines the imagename of the animal with it's id e.g. "Panda0".
        ...
        {
            Calculator.CalculateValues(numbers, "Decrease"); //As the operation is "decrease, it will cause the animals values to go down every 3 seconds.
        ...
        public void KillTimers()
        {
            ...
            decTimer.Enabled = false;// This disables the decTimer.
        }
