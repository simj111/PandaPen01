...
namespace CalculatorLibrary
{
    ...
    public class pandacalc2 : ICalculate
    {
        ...
        private string _imageName = "Panda"; //This is used to say which type of animal this calculator will be used for.
        ...
        public void CalculateValues(double[] numbers, string Operations)
        {
            ...
            //This reaches this if statement when the animals decrease timer has ticked and makes the non happiness values decrease by 4.
